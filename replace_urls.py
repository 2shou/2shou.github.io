...
"""
  ...
  其内容如下，其中{} 表示根据用户输入来更变的
    ...
    <head>
    <META HTTP-EQUIV=REFRESH CONTENT="5;URL=http://www.guoze.me/{}.html">
    </head>
    <body>
    很抱歉给您带来不便，由于站点URL规则更变，您可访问<a href="http://www.guoze.me/{}.html">{}</a>来进行文章阅读，也可以等待5秒后自动跳转到该页面。   
    <br>
...
<META HTTP-EQUIV=REFRESH CONTENT="5;URL=http://guoze.me/{}.html">
</head>
<body>
很抱歉给您带来不便，由于站点URL规则更变，您可访问<a href="http://guoze.me/{}.html">{}</a>来进行文章阅读，也可以等待5秒后自动跳转到该页面。
